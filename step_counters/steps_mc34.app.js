 ...
 * v3.4 set X_STEPS_COUNT=5 (dont change again), use OFFSET and set V_REGISTER = 20
 *     
 *
 *
 */
...
const V_REGISTER = 17;
const V_OFFSET = 0;        // for raw threshold check only subtract from raw signal as some cycles are always +ve
...
function onAccel(a) {
  ...
  if ( (v - V_OFFSET) > V_REGISTER || v < (-1*V_REGISTER -V_OFFSET) ) {
