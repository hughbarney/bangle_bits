 ...
 * v3.6 failed attempt to explore changing gating mechanism so must
...
const V_AREA_THRESHOLD = 300; // sum of abs(magnetude) over 1 second to be exceeded, screen out noise etc
...
function onAccel(a) {
  ...
  /**
   * (2) Gating the output of the filter
   *
   ...
   *
   * We sum up the absolute values of the samples over the last
   * second and ensure that it represents strong changes in the
   * magnetude of the acceleration.
   *
