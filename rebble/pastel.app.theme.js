...
//              black white  green  orange cyan   perple red    blue   
const bg_code = ['#000','#fff','#0f0','#ff0','#0ff','#f0f','#f00','#00f'];
const fg_code = ['#fff','#000','#000','#000','#000','#000','#fff','#fff'];
...
function set_theme() {
  ...
  g.setTheme({bg:bg_code[n],fg:fg_code[n],dark:true});
}
