...
function queueDraw() {
  ...
  drawTimeout = setTimeout(function() {
    ...
    draw();
  }, updateSecs - (Date.now() % updateSecs));
}
...
function setTheme() {
  ...
  let fgc = '#' + fg_map[R] + fg_map[G] + fg_map[B];
  let bgc = '#' + bg_map[R] + bg_map[G] + bg_map[B];
...
// blacl on copper
g.setTheme({bg:'#f80',fg:'#000',dark:true}).clear();
